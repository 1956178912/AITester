...
class TestBenchmarkTaskProperties:
    ...
    def test_pass_rate_calculation(self):
        ...
        task = BenchmarkTask(
            task_id="t1", repo_name="r", problem_statement="",
            instance_code="", test_code="", expected_pass_count=0, total_test_count=10,
        )
        task.mark_passed(7)
    ...
    def test_pass_rate_with_fraction(self):
        ...
        task = BenchmarkTask(
            task_id="t1", repo_name="r", problem_statement="",
            instance_code="", test_code="", expected_pass_count=0, total_test_count=3,
        )
        task.mark_passed(1)
...
class TestInMemoryDatasetMethods:
    ...
    def test_add_task_appends(self):
        ...
        from src.dataset_loader import InMemoryDataset, BenchmarkTask
        ds = InMemoryDataset()
        task = BenchmarkTask(
...
class TestLoadDatasetFactory:
    ...
    def test_load_by_full_name(self):
        """使用完整名称加载数据集。"""
        from src.dataset_loader import load_dataset, SWEBenchDataset, Defects4JPYDataset, InMemoryDataset
    ...
    def test_load_by_alias(self):
        """使用别名加载数据集。"""
        from src.dataset_loader import load_dataset, SWEBenchDataset, Defects4JPYDataset
    ...
    def test_unknown_name_returns_inmemory(self):
        ...
        from src.dataset_loader import load_dataset, InMemoryDataset

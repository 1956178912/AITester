...
class TestGenerate:
    ...
    def test_generate_calls_llm(self, mock_call_llm):
        ...
        result = agent.generate(
            test_plan={"function_name": "foo"}, target_code="def foo(): pass", module_name="test_module"
        )
    ...
    def test_generate_truncates_long_code(self, mock_call_llm):
        ...
        agent.generate(test_plan={"function_name": "foo"}, target_code=long_code, module_name="test_module")
    ...
    def test_generate_with_module_name_constraint(self, mock_call_llm):
        ...
        agent = GeneratorAgent()
        agent.generate(test_plan={"function_name": "foo"}, target_code="def foo(): pass", module_name="test_module")
